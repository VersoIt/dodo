...
import (
	...
	"github.com/versoit/diploma/services/analytics/internal/app"
...
func main() {
	fx.New(
		fx.Provide(
			func() *slog.Logger {
				return common.NewLogger("analytics-service")
			},
		),
		app.Module,
		fx.Invoke(RunServer),
...
func RunServer(lc fx.Lifecycle, handler *handler.AnalyticsHandler, logger *slog.Logger) {
