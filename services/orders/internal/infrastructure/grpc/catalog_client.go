...
func NewCatalogClient(lc fx.Lifecycle) (orders.CatalogService, error) {
...
func (c *catalogClient) GetProduct(ctx context.Context, id string) (*orders.ProductInfo, error) {
