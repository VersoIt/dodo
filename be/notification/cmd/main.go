...
import (
	...
	"github.com/versoit/diploma/be/notification/internal/app"
...
func RunServer(lc fx.Lifecycle, handler *handler.NotificationHandler, logger *slog.Logger, cfg *config.Config) {
